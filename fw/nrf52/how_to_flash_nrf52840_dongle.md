# Flash the Nordic nRF52840 dongle with Segger Embedded Studio (SES)

First, complete the toolchain setup, as described in **how_to_setup_nRF52_toolchain.md**

### To flash the US firmware to the nRF52840 dongle:
...
`fw/nrf52/nRF5_SDK_17.1.0/examples/peripheral/US_probe_dongle_firmware/pca10059/s140/ses/Output/Debug/Exe/`
...
- Press the reset button to put the dongle in DFU mode. Note that the reset button is the sideways button right next to the more visible SW1 button on the dongle.
